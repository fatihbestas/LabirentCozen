...
/*
 ...
 o yönlerinde duvar var mý yok mu bilgisini tutuyor olacak ve hedef o karenin ulaþýlmak istenen kare olup olmadýðýný tutacak.
 ...
 hoþ olmaz. O yüzden main() fonsiyonunda bir tane labirent giricem. Labirent deðiþtirilmek istenirse kodun içinde orasý deðiþtirilmeli. 
*/
...
void find_the_target_section(){
	...
	// baþlangýçta tüm kareleri ziyaret edilmedi ve finish deðil iþaretliyoruz.
